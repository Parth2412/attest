...
`pull-request-event.json`, `pull-request.json`, and `compare-page-{1,2}.json` form one exact
three-commit PR context. Tests mutate copies to prove PR drift, endpoint mismatch, pagination/count
failure, API caps, duplicate commits, and unmapped author or committer identity fail closed.
