...
> keyless Sigstore signing adapter are implemented. Independent verification is implemented and
> awaiting its required human security review; no CLI or production release exists yet.
